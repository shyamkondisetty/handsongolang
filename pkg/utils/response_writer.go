...
import (
	...
	// "payment-svc/pkg/http/internal/resperr"
)

func WriteSuccessResponse(resp http.ResponseWriter, statusCode int, data interface{}) {
	writeAPIResponse(resp, statusCode, NewSuccessResponse(data))
}
...
func writeAPIResponse(resp http.ResponseWriter, code int, ar APIResponse) {
